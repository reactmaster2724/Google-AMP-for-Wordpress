...
class AMPHTML_Tab_Templates extends AMPHTML_Tab_Abstract {
	...
	public function get_fields() {
		return array_merge( $this->get_404_fields( '404' ), $this->get_posts_fields( 'posts' ), $this->get_page_fields( 'pages' ), $this->get_search_fields( 'search' ), $this->get_blog_fields( 'blog' ), $this->get_archive_fields( 'archives' ) );
	}
	...
	public function display_textarea_field( $args ) {
		...
		?>
		<textarea id="<?php echo $id ?>" name="<?php echo $name ?>" rows="6"
		          cols="46"><?php echo trim( $this->options->get( $id ) ); ?></textarea>
	...
	public function get_search_fields( $section ) {
		...
		$fields = array (
			...
			array (
				...
				'section'               => $section,
				'display_callback'      => array ( $this, '' ),
				'display_callback_args' => array ( 'search_page_excerpt' ),
	...
	public function get_blog_fields( $section ) {
		...
		$fields = array (
			...
			array (
				...
				'section'               => $section,
				'display_callback'      => array ( $this, '' ),
				'display_callback_args' => array ( 'blog_page_excerpt' ),
				'description'           => __( 'Show excerpt', 'amphtml' ),
			),
		);
	...
	public function get_archive_fields( $section ) {
		...
		$fields = array (
			...
			array (
				...
				'section'               => $section,
				'display_callback'      => array ( $this, '' ),
				'display_callback_args' => array ( 'archive_excerpt' ),
	...
	public function display_archive_content_block() {
		...
		<fieldset>
			...
			<?php $this->display_checkbox_field( array ( 'archive_excerpt' ) ); ?>
		</fieldset>
		<?php
	}
	...
	public function display_blog_content_block() {
		...
		<fieldset>
			...
			<?php $this->display_checkbox_field( array ( 'blog_page_excerpt' ) ); ?>
		</fieldset>
		<?php
	}
	...
	public function display_search_page_content_block() {
		...
		<fieldset>
			...
			<?php $this->display_checkbox_field( array ( 'search_page_excerpt' ) ); ?>
		</fieldset>
		<?php
	}
