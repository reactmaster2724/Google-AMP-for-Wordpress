...
abstract class AMPHTML_Tab_Abstract {
	...
	public function __construct( $name, $options, $is_current = false ) {
		...
		$this->current_section = $this->options->get_request_var( 'section', current( array_keys( $this->get_sections() ) ) );
	...
	public function display_fields() {
		...
		foreach ( $this->get_section_fields( $id ) as $field ) {
			...
			add_settings_field( $field['id'], $field['title'], $field['display_callback'], AMPHTML_Options::OPTIONS_PAGE, $id, $display_callback_args );
